              ...
              <Card className="p-8 border-2 border-gray-200 hover:border-[#ffc107] transition-colors h-full">
                ...
                <div className="space-y-3 bg-gray-50 p-4 rounded-lg">
                  <div>
                    ...
                    <p className="font-bold text-[#1a1a1a]">ACMEC Trust</p>
                  </div>
                  <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-[#1a1a1a]/80 text-lg max-w-3xl mx-auto mb-8">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. All donations to ACMEC Trust are eligible for tax
            ...
            <Card className="p-6 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">Lorem ipsum dolor sit amet</p>
                  <a href="mailto:donate@acmectrust.org" className="text-[#a7150b] font-bold hover:underline">
                    donate@acmectrust.org
                  </a>
                </div>
              </div>
            </Card>
            ...
            {[
              {
                name: "Rajesh Kumar",
                quote:
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proud to support such a noble cause. The transparency and dedication of ACMEC Trust is commendable.",
                location: "Chennai",
              },
              {
                name: "Priya Sharma",
