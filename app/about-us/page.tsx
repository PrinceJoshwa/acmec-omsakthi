...
//               Adhiparasakthi Charitable Medical, Educational, and Cultural Trust (ACMEC Trust)
//             </motion.p>
//           </motion.div>
//         </div>
//       </section>
...
//                    <p>
//                       Adhiparasakthi Charitable Medical, Educational, and Cultural Trust (ACMEC Trust) was established in 1978 by His Holiness Bangaru Adigalar with a modest corpus fund and a few cents of land in Melmaruvathur, Tamil Nadu.
//                    </p>
//                    <p>
//                       Initially a small village located 92 km from Chennai and 70 km from Pondicherry, Melmaruvathur has grown significantly, thanks in large part to the Trust’s efforts. ACMEC Trust is a non-profit organization dedicated to serving the community through various charitable, medical, educational, and cultural initiatives.
//                    </p>
//                 </div>
//              </motion.div>
...
//                   ACMEC Trust’s core objective is to provide equitable services to people deprived of income, employment, health, and a good living environment.
//                </p>
//             </motion.div>
...
//                            <p className="text-slate-600 mt-2 leading-relaxed">
//                               From pre-primary schools to higher education colleges, ACMEC Trust provides sponsored education to the poor and has established premier educational institutions.
//                            </p>
//                         </div>
//                      </div>
//                   </Card>
         ...
         <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="max-w-4xl mx-auto text-center mb-16">
               ...
               <p className="text-slate-600 text-lg leading-relaxed">
                  ACMEC Trust’s core objective is to provide equitable services to people deprived of income, employment, health, and a good living environment. Its significant activities include:
               </p>
            </motion.div>
