        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg border-t-8 border-[#a7150b]">
          ...
          <div className="prose max-w-none text-gray-700 space-y-10 leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">
                If you have any questions about this Privacy Policy, please feel free to contact us through our website or write to us at <a href="mailto:info@acmectrust.org" className="text-blue-600 hover:underline">info@acmectrust.org</a>.
              </p>
            ...
            <section>
              ...
              <p>
                If you wish to stop any further sms/email alerts/contacts from our side, all you need to do is to send an email to <a href="mailto:info@acmectrust.org" className="text-blue-600 hover:underline">info@acmectrust.org</a> with your mobile numbers and you will be excluded from the alerts list.
              </p>
            </section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <a href="mailto:info@acmectrust.org" className="text-[#1a1a1a] hover:text-[#a7150b] transition-colors">info@acmectrust.org</a>
                </div>
