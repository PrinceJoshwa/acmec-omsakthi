        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-[#FFC800] font-bold text-lg leading-tight">ACMEC Trust</h2>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-3">
                ...
                <p className="leading-relaxed opacity-90 text-white">
                  No.1 GST Road, Adhiparasakthi Siddhar Peedam, <br/>
      ...
      <div className="bg-[#FFC800] text-black py-4 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm font-bold text-center md:text-left">
            Copyright @ {currentYear} ACMEC Trust. All rights reserved.
          </p>
